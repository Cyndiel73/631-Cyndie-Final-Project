...
Thor won 12 times out of 52 shows.  So his probability of winning is 
```{r echo=TRUE}
ProbThorWin <- 12/52
ProbThorWin
```
...
```
I thought about trying to see how Thor stacked up against the overall probabilty, but I am not sure if I am calculating that correctly.  If I take the probability of winning at any event, and take the average, is that overall probability?  In my dataset, I have that calculated as 1(winner)/Dogs in BOB.  

```{r}
mean(1/Thor_Data$`Dogs in BOB`)
```
I do struggle with interpreting that.  I would look at that and say, any dog has about an 18% chance of winning. And based on what I calculated Thor's probabilty of winning based on the times he won in the 52 events (12/52), I show he has a 23% chance of winning.  But I am not sure if that is the correct way.  
...
## Joint Probabilites:
While I was working on this I went back to the book, amd reviewed Joint Probabilities and created a table for myself to help check my answers.  I was trying to figure out how, without just uploading the data, to get it into R Markdown, but have not suceeded in that yet   

## Conditional Probabilities:
Again, going to the book to confirm what I was calculating, I reviewed Conditional Probabalities that shows the outcome A (Thor Winning) give Condition B (Female Judge). Then I took that a step farther, and said the outcome of Thor winning with a female judge, given the event is inside.
